...
|---------------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| ***v1.12.2*** | [jsDelivr](https://cdn.jsdelivr.net/npm/jsxgraph@1.12.2/distrib/jsxgraphcore.js) | [cdnjs](https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/1.12.2/jsxgraphcore.js) | [JSXGraph server](https://jsxgraph.uni-bayreuth.de/distrib/jsxgraphcore-1.12.1.js) |
| ***v1.12.1*** | jsDelivr | [cdnjs](https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/1.12.1/jsxgraphcore.js) | [JSXGraph server](https://jsxgraph.uni-bayreuth.de/distrib/jsxgraphcore-1.12.1.js) |
| ***v1.12.0*** | [jsDelivr](https://cdn.jsdelivr.net/npm/jsxgraph@1.12.0/distrib/jsxgraphcore.js) | cdnjs | [JSXGraph server](https://jsxgraph.uni-bayreuth.de/distrib/jsxgraphcore-1.12.0.js) |
